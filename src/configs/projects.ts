// 模拟项目图片
const defaultImg = 'https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png';
...
export const projects = [
  ...
  },
  {
    ...
    tags: ['CocosCreator', 'TypeScript', 'WebSocket', 'Worker', '性能优化', '游戏开发']
  },
  {
    id: 4,
...
export const personalWorks = [
  {
    id: 1,
    title: '个人技术博客',
    description: '使用Next.js开发的个人技术博客，记录学习心得和技术分享。',
    image: defaultImg,
  ...
  },
  {
    id: 2,
    title: '前端组件库',
    description: '基于React开发的组件库，包含常用UI组件和功能组件。',
    image: defaultImg,
  ...
  },
  {
    id: 3,
    title: '小游戏Demo',
    description: '使用Eva.js开发的2D游戏Demo，展示游戏开发能力。',
    image: defaultImg,
    link: 'https://example.com/game-demo',
    tags: ['Eva.js', 'Canvas', '游戏开发']
  }
]; 