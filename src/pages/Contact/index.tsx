  ...
  return (
    <div className={styles.container}>
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} md={8}>
            <Card className={styles.contactCard}>
              ...
              <Title level={4} className={styles.cardTitle}>电话</Title>
          ...
          <Col xs={24} md={8}>
            <Card className={styles.contactCard}>
              ...
              <Title level={4} className={styles.cardTitle}>邮箱</Title>
              <Paragraph className={styles.contactValue}>
          ...
          <Col xs={24} md={8}>
            <Card className={styles.contactCard}>
              ...
              <Title level={4} className={styles.cardTitle}>Github</Title>
              <Paragraph className={styles.contactValue}>
                <Text>个人项目仓库</Text>
              </Paragraph>
              <Button 
      ...
      <div className={styles.formSection}>
        <Title level={3} className={styles.formTitle}>给我留言</Title>
